...
For the app see [X-Pat | X-Change] (https://fierce-ridge-01437.herokuapp.com/) The
...
----
>(R11)
<img src="../docs/XPAT_XCHANGE_SITEMAP.png">

## ABSTRACTIONS, DATABASE MODEL, &  RELATIONSHIPS
----
>(R15, R17 & R18)

X-Pat | X-Change uses three 

This application currently has three models; User, Product, and Order. 
...
[GitHub](https://github.com/srahooa/xpat-xchange/blob/master/docs/X-pat_X-change%20ERD.png)
